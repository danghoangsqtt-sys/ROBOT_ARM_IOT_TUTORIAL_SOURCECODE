...
public:
    ...
    // Execute a command string and capture the response
    String execute(const char* cmdStr);
...
private:
    ...
    String*    _responseCapture; // if non-null, redirects responds to this String instead of Serial
