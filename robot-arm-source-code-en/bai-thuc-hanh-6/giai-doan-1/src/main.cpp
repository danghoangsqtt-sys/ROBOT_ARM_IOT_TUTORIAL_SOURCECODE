...
// Khoi tao PCA9685 tai dia chi I2C 0x40
...
/*-----------------------------------------------------------------------
  angleToPulse: Chuyen goc (do) sang gia tri xung PWM 12-bit
...
void setup() {
  ...
  // Khoi tao PCA9685 va dat tan so PWM 50Hz cho servo
  pca.begin();
  pca.setPWMFreq(50);
