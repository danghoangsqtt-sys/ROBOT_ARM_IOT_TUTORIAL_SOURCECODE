...
# LAB 5 - STAGE 3
# File: serial_comm.py
# Description: Serial communication module voi Robot Arm
# =============================================
...
class RobotSerial:
    ...
    def __init__(self):
        """Initialize trang thai ban dau: chua ket noi."""
        self.ser = None
    ...
    def connect(self, port: str) -> bool:
        ...
        try:
            ...
            # Doc cac dong Initialize ma ESP32 gui ra khi boot
    ...
    def send(self, cmd: str) -> str:
        """Send command den Robot va tra ve phan hoi.
        ...
        try:
            ...
            print(f"[LOI] Send command that bai: {e}")
            return "ERR:TIMEOUT"
